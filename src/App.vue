...
export default {
  ...
  methods: {
    RequestMoviesFromApi() {
      axios.get("https://api.themoviedb.org/3/search/movie?api_key=bfc4b1b7a0f2098e7faca48ae85e05a5&query=all").then(response => (this.store.ArrMovies = response.data.results));
    }
  },
  created() {
